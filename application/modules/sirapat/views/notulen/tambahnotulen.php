...
<?= form_open_multipart('sirapat/admin/notulen/tambahnotulen'); ?>
  ...
  <div class="form-group">
    ...
    id="nama_agenda" placeholder="Ruang Rapat" name="ruang_rapat">
  ...
  <div class="form-group">
    ...
    id="waktu" placeholder="Contoh : 12:00 Wib" name="waktumulai">
  ...
  <div class="form-group">
    ...
    <input type="time" class="form-control" 
    id="waktu" placeholder="Contoh : 12:00 Wib" name="waktuselesai">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
    id="formGroupExampleInput2" placeholder="Surat Undangan No." name="nomor_surat">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
    id="formGroupExampleInput2" placeholder="Daftar Hadir" name="daftar_hadir">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
    id="formGroupExampleInput2" placeholder="Total Hadir" name="total_hadir">
  ...
  <label for="formGroupExampleInput2">Ketua Rapat</label>
              ...
              <select name="ketua_rapat" id="pimpinan" class="form-control">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" 
    id="formGroupExampleInput2" placeholder="PIC" name="pic">
  ...
  <div class="form-group">
    ...
    id="formGroupExampleInput2" placeholder="Ringkasan" name="ringkasan"></textarea>
  ...
  <button type="reset" class="btn btn-dark float-right"><i class="fa fa-plus"></i> Tambah Risalah Rapat</button>
